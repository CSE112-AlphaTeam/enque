...
/** 
 * @description Function to add text messaging bot support
 * @param dst - Destination of text message
 * @param text - Text written in text message
 * @param fn - Function being called upon
 * @returns N/A
 */
