...
/**
 * @description Calls compareSync to check the given password against the password stored in the database
...
/**
 * @description Verifies if a mobile token is proper.
 *
...
/**
 * @description Verifies that a login is valid before calling a function
 *
 * @param {Object} db A mongoDB
...
/**
 * @description Middleware authentication which will call the next function if successful
